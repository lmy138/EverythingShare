...
| Project | Use | License |
|---|---|---|
| Everything by voidtools | External dependency in standard deployments; official portable x64 executable embedded only in the OneClick package | MIT-style license |
